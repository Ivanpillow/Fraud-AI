...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'components-contabilidad-form-cuenta-contable': RouteRecordInfo<'components-contabilidad-form-cuenta-contable', '/components/contabilidad/form-cuenta-contable', Record<never, never>, Record<never, never>>,
    'components-contabilidad-movimientos-auxiliares': RouteRecordInfo<'components-contabilidad-movimientos-auxiliares', '/components/contabilidad/movimientos-auxiliares', Record<never, never>, Record<never, never>>,
    'components-contabilidad-seleccionar-cuenta-contable': RouteRecordInfo<'components-contabilidad-seleccionar-cuenta-contable', '/components/contabilidad/seleccionar-cuenta-contable', Record<never, never>, Record<never, never>>,
    'components-contabilidad-seleccionar-poliza': RouteRecordInfo<'components-contabilidad-seleccionar-poliza', '/components/contabilidad/seleccionar-poliza', Record<never, never>, Record<never, never>>,
    'components-dialog': RouteRecordInfo<'components-dialog', '/components/dialog', Record<never, never>, Record<never, never>>,
    'components-dialogs-accion-modal': RouteRecordInfo<'components-dialogs-accion-modal', '/components/dialogs/accion-modal', Record<never, never>, Record<never, never>>,
    'components-dialogs-mensaje-temporal-dialog': RouteRecordInfo<'components-dialogs-mensaje-temporal-dialog', '/components/dialogs/mensaje-temporal-dialog', Record<never, never>, Record<never, never>>,
    ...
    'contabilidad-administrar-polizas': RouteRecordInfo<'contabilidad-administrar-polizas', '/contabilidad/administrar-polizas', Record<never, never>, Record<never, never>>,
    'contabilidad-borrarform-cuenta-contable': RouteRecordInfo<'contabilidad-borrarform-cuenta-contable', '/contabilidad/BORRAR-form-cuenta-contable', Record<never, never>, Record<never, never>>,
    'contabilidad-borrarseleccionar-cuenta-contable': RouteRecordInfo<'contabilidad-borrarseleccionar-cuenta-contable', '/contabilidad/BORRAR-seleccionar-cuenta-contable', Record<never, never>, Record<never, never>>,
    'contabilidad-borrarseleccionar-poliza': RouteRecordInfo<'contabilidad-borrarseleccionar-poliza', '/contabilidad/BORRAR-seleccionar-poliza', Record<never, never>, Record<never, never>>,
    'contabilidad-ejemplo': RouteRecordInfo<'contabilidad-ejemplo', '/contabilidad/ejemplo', Record<never, never>, Record<never, never>>,
    'contabilidad-reportes-movimientos-auxiliares': RouteRecordInfo<'contabilidad-reportes-movimientos-auxiliares', '/contabilidad/reportes/movimientos-auxiliares', Record<never, never>, Record<never, never>>,
    ...
    'direccion-reporte-total-rentas': RouteRecordInfo<'direccion-reporte-total-rentas', '/direccion/reporte-total-rentas', Record<never, never>, Record<never, never>>,
    ...
    'lista-usuarios': RouteRecordInfo<'lista-usuarios', '/lista-usuarios', Record<never, never>, Record<never, never>>,
    'login': RouteRecordInfo<'login', '/login', Record<never, never>, Record<never, never>>,
    'login-copy': RouteRecordInfo<'login-copy', '/login_copy', Record<never, never>, Record<never, never>>,
    ...
    'usuarios-empleados': RouteRecordInfo<'usuarios-empleados', '/usuarios/empleados', Record<never, never>, Record<never, never>>,
