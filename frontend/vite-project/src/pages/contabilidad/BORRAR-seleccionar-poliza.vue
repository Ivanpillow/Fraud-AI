...
const modalVisibleCC = ref(false) // Control del modal de cuentas contables
...
// Función placeholder para la validación (ajusta según tu lógica real)
        ...
        <VForm>
          ...
          <VRow>
            <InputCuentaContable
                ...
                :is-movimiento-en-caja="isMovimientoEnCaja"
                :is-poliza-bloqueada="isPolizaBloqueada"
